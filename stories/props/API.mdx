...
- <LinkTo kind="props" story="localizer">Example</LinkTo>
...
- type: `object`
- <LinkTo kind="props" story="element-props">Example</LinkTo>
...
- type: `function () => Date`
- default: `() => new Date()`
- <LinkTo kind="props" story="get-now">Example</LinkTo>
...
- default: `new Date()`
- <LinkTo kind="props" story="default-date">Example</LinkTo>
...
- <LinkTo kind="props" story="date">Example</LinkTo>
...
- <LinkTo kind="props" story="on-navigate">Example</LinkTo>
...
- <LinkTo kind="props" story="default-view">Example</LinkTo>
...
- <LinkTo kind="props" story="view">Example</LinkTo>
...
- <LinkTo kind="props" story="on-view">Example</LinkTo>
...
- type: `arrayOf(Event)`
- default: `[]`
- <LinkTo kind="props" story="events">Example</LinkTo>
...
- default: `[]`
- <LinkTo kind="props" story="background-events">Example</LinkTo>
...
- <LinkTo kind="props" story="background-event-prop-getter">Example</LinkTo>
...
- default: 'title'
- <LinkTo kind="props" story="title-accessor">Example</LinkTo>
...
- type: `string | function (event: Object) => string`
- default: 'title'
- <LinkTo kind="props" story="tooltip-accessor">Example</LinkTo>
...
- default: 'start'
- <LinkTo kind="props" story="start-accessor">Example</LinkTo>
...
- type: `string | function (event: Object) => Date`
- default: 'end'
- <LinkTo kind="props" story="end-accessor">Example</LinkTo>
...
- default: 'allDay'
- <LinkTo kind="props" story="all-day-accessor">Example</LinkTo>
...
- type: `number`
- default: `Infinity`
- <LinkTo kind="props" story="all-day-max-rows">Example</LinkTo>
...
- <LinkTo kind="props" story="resources">Example</LinkTo>
...
- <LinkTo kind="props" story="resource-id-accessor">Example</LinkTo>
...
- <LinkTo kind="props" story="resource-title-accessor">Example</LinkTo>
...
- <LinkTo kind="props" story="on-drill-down">Example</LinkTo>
...
- <LinkTo kind="props" story="on-range-change">Example</LinkTo>
...
- <LinkTo kind="props" story="selectable">Example</LinkTo>
...
- <LinkTo kind="props" story="on-select-slot">Example</LinkTo>
...
- <LinkTo kind="props" story="on-select-event">Example</LinkTo>
...
- type: `function (event: Object) => any`
- <LinkTo kind="props" story="on-double-click-event">Example</LinkTo>
...
- requires: <LinkTo kind="props" story="selectable">selectable</LinkTo>
- <LinkTo kind="props" story="on-selecting">Example</LinkTo>
...
- <LinkTo kind="props" story="on-show-more">Example</LinkTo>
...
- type: `boolean`
- <LinkTo kind="props" story="do-show-more-drill-down">Example</LinkTo>
...
- <LinkTo kind="props" story="on-key-press-event">Example</LinkTo>
...
- type: `boolean`
- default: `false`
- <LinkTo kind="props" story="show-all-events">Example</LinkTo>
...
- type: `Event: Object`
- <LinkTo kind="props" story="selected">Example</LinkTo>
...
- <LinkTo kind="props" story="cal-views">Example</LinkTo>
...
- type: `string`
- default: `Views.DAY`
- <LinkTo kind="props" story="drilldown-view">Example</LinkTo>
...
- <LinkTo kind="props" story="get-drilldown-view">Example</LinkTo>
...
- type: `number`
- default: `30`
- <LinkTo kind="props" story="length">Example</LinkTo>
...
- type: `boolean`
- default: `true`
- <LinkTo kind="props" story="toolbar">Example</LinkTo>
...
- type: `boolean`
- default: `true`
- <LinkTo kind="props" story="popup">Example</LinkTo>
...
- <LinkTo kind="props" story="popup-offset">Example</LinkTo>
...
- type: `number`
- default: `250`
- <LinkTo kind="props" story="long-press-threshold">Example</LinkTo>
...
- type: `number`
- default: `30`
- <LinkTo kind="props" story="step">Example</LinkTo>
...
- type: `number`
- <LinkTo kind="props" story="timeslots">Example</LinkTo>
...
- type: `boolean`
- default: `false`
- <LinkTo kind="props" story="right-to-left">Example</LinkTo>
...
- type: `function (event: Object, start: Date, end: Date, isSelected: boolean) => {className?: string, style?: Object}`
- <LinkTo kind="props" story="event-prop-getter">Example</LinkTo>
...
- <LinkTo kind="props" story="on-slot-prop-getter">Example</LinkTo>
...
- <LinkTo kind="props" story="slot-group-prop-getter">Example</LinkTo>
...
- type: `function (date: Date) => {className?: string, style?: Object}`
- <LinkTo kind="props" story="day-prop-getter">Example</LinkTo>
...
- type: `boolean`
- default: `false`
- <LinkTo kind="props" story="show-multi-day-times">Example</LinkTo>
...
- <LinkTo kind="props" story="min">Example</LinkTo>
...
- <LinkTo kind="props" story="max">Example</LinkTo>
...
- type: `instanceOf(Date)`
- default: `new Date()`
- <LinkTo kind="props" story="scroll-to-time">Example</LinkTo>
...
- <LinkTo kind="props" story="culture">Example</LinkTo>
...
- type: `Object`
- <LinkTo kind="props" story="formats">Example</LinkTo>

<LinkTo kind="props" story="localizer">Localizer</LinkTo> specific formats, tell the Calendar how to format and display dates and
times.
...
- <LinkTo kind="props" story="formats-date-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-day-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-weekday-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-time-gutter-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-month-header-format">Example</LinkTo>
...
- <LinkTo kind="props" story="formats-day-range-header-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-day-header-format">Example</LinkTo>
...
- type: `function (range: Object {start: Date, end: Date}, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-agenda-header-format">Example</LinkTo>
...
- type: `function (range: Object {start: Date, end: Date}, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-select-range-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-agenda-date-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-agenda-time-format">Example</LinkTo>
...
- type: `function (range: Object {start: Date, end: Date}, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-agenda-time-range-format">Example</LinkTo>
...
- type: `function (range: Object {start: Date, end: Date}, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-event-time-range-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-event-time-range-start-format">Example</LinkTo>
...
- type: `function (date: Date, culture: ?string, localizer: DateLocalizer) => string`
- <LinkTo kind="props" story="formats-event-time-range-end-format">Example</LinkTo>
...
- type: `object`
- <LinkTo kind="props" story="components">Example</LinkTo>
...
- type: `Object`
- <LinkTo kind="props" story="messages">Example</LinkTo>
...
- default: `overlap`
- <LinkTo kind="props" story="day-layout-algorithm">Example</LinkTo>
