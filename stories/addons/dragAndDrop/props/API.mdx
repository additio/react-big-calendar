...
- <LinkTo kind="addons-drag-and-drop-props" story="on-event-drop">Example</LinkTo>
...
- <LinkTo kind="addons-drag-and-drop-props" story="on-drag-start">Example</LinkTo>
...
- <LinkTo kind="addons-drag-and-drop-props" story="on-drop-from-outside">Example</LinkTo>
...
- <LinkTo kind="addons-drag-and-drop-props" story="drag-from-outside-item">Example</LinkTo>
...
- <LinkTo kind="addons-drag-and-drop-props" story="on-drag-over">Example</LinkTo>
...
- default: `() => true`
- <LinkTo kind="addons-drag-and-drop-props" story="draggable-accessor">Example</LinkTo>
...
- type: `boolean`
- default: `true`
- <LinkTo kind="addons-drag-and-drop-props" story="resizable">Example</LinkTo>
...
- <LinkTo kind="addons-drag-and-drop-props" story="on-event-resize">Example</LinkTo>
...
- type: `string|function (event) => boolean`
- default: `() => true`
- <LinkTo kind="addons-drag-and-drop-props" story="resizable-accessor">Example</LinkTo>
